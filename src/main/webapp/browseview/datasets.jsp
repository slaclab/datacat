...
<div class="datacat-component">
    ...
    <nav>
      <ul class="pager">
        <li class="previous <c:if test="${empty previous}">disabled</c:if>"> 
            <a href="<c:if test="${!empty previous}">${pageContext.request.contextPath}/browser${target.path}?${previous}</c:if>">
                <span aria-hidden="true">&larr;</span> Previous
            </a>
        </li>
        <li class="next <c:if test="${empty next}">disabled</c:if>">
            
            <a href="<c:if test="${!empty next}">${pageContext.request.contextPath}/browser${target.path}?${next}</c:if>">
